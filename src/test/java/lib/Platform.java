...
public class Platform {
    ...
    public RemoteWebDriver getDriver() throws Exception
    {
        ...
        if(this.isAndroid()){
            ...
            throw new Exception("Не поределен тип платформы" + this.getPlatformVar());
        }
    }
    ...
    private DesiredCapabilities getAndroidDesiredCapabilities()
    {
        ...
        capabilities.setCapability("app", "/Users/admin/Desktop/org.wikipedia.apk");
        return capabilities;
